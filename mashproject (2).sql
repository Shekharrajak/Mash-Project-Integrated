...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2015 at 11:10 AM
...
Database author : Shekhar Prasad Rajak*/;
...
`partner_id` int(11) NOT NULL,
  `partner_img` varchar(200) NOT NULL,
  `partner_title` varchar(520) NOT NULL,
  `partner_cotitle` varchar(520) NOT NULL,
...
INSERT INTO `partner` (`partner_id`, `partner_img`, `partner_title`, `partner_cotitle`, `partner_desc`) VALUES
(1, 'images/partners/CoWorkIn-logo.jpg', 'coworking.co', 'Connect | Collaborate | CoWork', 'CoworkIn is a network of coworking spaces and their member coworkers to connect with the entrepreneurial and social community across the spaces. CoworkIn allows all members and spaces to interact with each other, share resources and build their own local communities.'),
(2, 'images/partners/human-circle-logo.png', 'Human Circle', 'Connecting enlightened minds', 'Human Circle is a movement to inspire and enable young people to do what they love. It is an experiential platform comprising of physical and virtual forums like conferences, workshops, retreats and online communities, to empower people with mindsets and skills required to become impact individuals.'),
(3, 'images/partners/josh-talks-logo.png', 'Josh Talks', 'Inspiring Thought!', 'Josh Talks is a platform that showcases India’s most inspiring stories to you. It features and highlights the struggle that people go through, the pain they have to suffer and the obstacles they have to overcome to reach their ultimate goal of success. It aims to disrupt you, move you, motivate you and inspire you.');
